...
public class PreExamDAO {
    private final static String URL = "jdbc:h2:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TRUE;";

    private final static String USER_NAME = "b2220100";

    private final static String USER_PASS = "b2220100";
